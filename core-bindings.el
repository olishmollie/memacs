;;; core-bindings.el --- Emacs bindings.
...
(defvar memacs-file-prefix-bindings '(("f" . ("find-file" . counsel-find-file)))
...
(defun memacs/replace-prefix-key-name (prefix-key key name)
  "Replaces which-key binding given by regex 'memacs-prefix-key? PREFIX-KEY KEY' with NAME."
